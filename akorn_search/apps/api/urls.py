...
urlpatterns = patterns('',
    ...
    url(r'^latest_articles_matching_keyword_and_journals$', views.latest_articles_matching_keyword_and_journals, name='latest_articles_matching_keyword_and_journals'),
